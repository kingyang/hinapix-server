...
public class AuditMessageImpl
    extends com.hinacom.pix.ihe.audit.jaxb.impl.AuditMessageTypeImpl
    implements com.hinacom.pix.ihe.audit.jaxb.AuditMessage, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, com.hinacom.pix.ihe.audit.jaxb.impl.runtime.UnmarshallableObject, com.hinacom.pix.ihe.audit.jaxb.impl.runtime.XMLSerializable, com.hinacom.pix.ihe.audit.jaxb.impl.runtime.ValidatableObject
{
    ...
    private final static Class PRIMARY_INTERFACE_CLASS() {
        return (com.hinacom.pix.ihe.audit.jaxb.AuditMessage.class);
    }
    ...
    public com.hinacom.pix.ihe.audit.jaxb.impl.runtime.UnmarshallingEventHandler createUnmarshaller(com.hinacom.pix.ihe.audit.jaxb.impl.runtime.UnmarshallingContext context) {
        return new com.hinacom.pix.ihe.audit.jaxb.impl.AuditMessageImpl.Unmarshaller(context);
    }
...
+"~\u0000[q\u0000~\u0000\fq\u0000~\u0000\tq\u0000~\u0000\nx"));
        ...
        extends com.hinacom.pix.ihe.audit.jaxb.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public Object owner() {
            return com.hinacom.pix.ihe.audit.jaxb.impl.AuditMessageImpl.this;
        }
                ...
                switch (state) {
                    ...
                    case  1 :
                        if (("EventIdentification" == ___local)&&("" == ___uri)) {
                            spawnHandlerFromEnterElement((((com.hinacom.pix.ihe.audit.jaxb.impl.AuditMessageTypeImpl)com.hinacom.pix.ihe.audit.jaxb.impl.AuditMessageImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                }
