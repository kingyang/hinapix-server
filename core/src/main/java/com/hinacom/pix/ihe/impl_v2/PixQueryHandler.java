...
import com.hinacom.pix.ihe.registry.HL7;
 ...
 * 
 * @see com.hinacom.pix.ihe.impl_v2.PixFeedHandler
 *
 */
public class PixQueryHandler extends BaseHandler implements Application {
    ...
    throws ApplicationException, HL7Exception {
        ...
        // ITI-8-Feed-Valid-Domain-A01 Test - The Message Structure ID should be 'RSP^K23^RSP_K23'
        reply.getMSH().getMessageType().getMessageStructure().setValue("RSP_K23");
