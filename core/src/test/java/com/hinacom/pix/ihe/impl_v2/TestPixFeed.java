 ...
 */
package com.hinacom.pix.ihe.impl_v2;
...
import com.hinacom.pix.ihe.log.IMessageStoreLogger;
import com.hinacom.pix.ihe.log.MessageStore;
...
public class TestPixFeed extends TestCase {
	public static void main(String[] args) {
        TestPixFeed testRunner = new TestPixFeed();

        testRunner.setUp();
		testRunner.testPatientAdmitReceivingApplication();

        /*
        testRunner.testInvalidPixFeedPatientAdmit();



        testRunner.testPatientAdmitReceivingFacility();
        testRunner.testPatientAdmitRequestDomain();
        testRunner.testPatientAdmitSuccess();
        testRunner.testUpdatePatientRequestId();
        testRunner.testUpdatePatientSuccess();
        testRunner.testInvalidMergePatient();
        testRunner.testPixFeedMergeSuccess();
        */
	}
	...
	public void setUp() {
	        ...
	        try {
	            ...
	            URL url = TestPixQuery.class.getResource("/conf/tests/actors/IheActors.xml");
                ...
                // pixAdapter = new MockPixAdapter();
                pixAdapter = (IPixManagerAdapter)applicationContext.getBean("pixManagerAdapter");
                actor.registerPixManagerAdapter(pixAdapter);

                IMessageStoreLogger storeLogger = (IMessageStoreLogger)applicationContext.getBean("storeLogger");
	...
	public void testInvalidPixFeedPatientAdmit(){	      
		String msh="MSH|^~\\&|EHR_MISYS|MISYS|PAT_IDENTITY_X_REF_MGR_IBM1|IBM|20060809155816-0400||ADT^A03|PIF_0|P|2.3.1||||||||\r"+ 
		"EVN|A07|20060809155816||||20060809155814\r"+
		"PID|||12345678^^^HIMSS2005&1.3.6.1.4.1.21367.2005.1.1&ISO^PI||DePinto^Joe^V^Jr^Dr.|Wang|19580325|M|||||(716)385-6235^PRN^PH^^^716^3856235\r"+
		"PV1||O";
	...
	public void testPatientAdmitReceivingApplication(){	      
		String msh="MSH|^~\\&|EHR_MISYS|MISYS|PAT_IDENTITY_X_REF_MGR_IBM1|IBM|20060809155816-0400||ADT^A01|PIF_0|P|2.3.1||||||||\r"+ 
		"EVN|A07|20060809155816||||20060809155814\r"+
		"PID|||12345678^^^HIMSS2005&1.3.6.1.4.1.21367.2005.1.1&ISO^PI||DePinto^Joe^V^Jr^Dr.|Wang|19580325|M|||||(716)385-6235^PRN^PH^^^716^3856235\r"+
		"PV1||O";
	        PipeParser pipeParser = new PipeParser();
	...
	public void testPatientAdmitReceivingFacility(){	      
		String msh="MSH|^~\\&|PAT_IDENTITY_X_REF_MGR_IBM1|IBM1|EHR_MISYS|IBM|20060809155816-0400||ADT^A01|PIF_0|P|2.3.1||||||||\r"+ 
		"EVN|A07|20060809155816||||20060809155814\r"+
		"PID|||12345678^^^HIMSS2005&1.3.6.1.4.1.21367.2005.1.1&ISO^PI||DePinto^Joe^V^Jr^Dr.|Wang|19580325|M|||||(716)385-6235^PRN^PH^^^716^3856235\r"+
		"PV1||O";
	        PipeParser pipeParser = new PipeParser();
	...
	public void testPatientAdmitRequestDomain(){	      
		String msh="MSH|^~\\&|PAT_IDENTITY_X_REF_MGR_IBM1|IBM1|EHR_MISYS|MISYS|20060809155816-0400||ADT^A01|PIF_0|P|2.3.1||||||||\r"+ 
		"EVN|A07|20060809155816||||20060809155814\r"+
		"PID|||12345678^^^HIMSS2005&1.3.6.1.4.1.21367.2005.1.1&ISO^PI||DePinto^Joe^V^Jr^Dr.|Wang|19580325|M|||||(716)385-6235^PRN^PH^^^716^3856235\r"+
		"PV1||O";
	        PipeParser pipeParser = new PipeParser();
	...
	public void testPatientAdmitSuccess(){	      
		String msh="MSH|^~\\&|CLINREG|WESTCLIN|EHR_MISYS|MISYS|20060809155816-0400||ADT^A01|PIF_0|P|2.3.1||||||||\r"+ 
		"EVN|A01|20060809155816||||20060809155814\r"+
		"PID|||112236^^^WESTCLINIC&1.2234.634325.5734&ISO^PI||DePinto^Joe^V^Jr^Dr.|Wang|19580325|M|raja|^race^^^^|||(716)385-6235^PRN^PH^^^716^3856235||tamil|^U^^^^|^hindu^^^^|077746567576|666777888|9877876|priya|^ethnic^^^^|tamilnadu||1|^indian^^^^||||090120071011|1|\r"+
		"PV1||O";
	        PipeParser pipeParser = new PipeParser();
	        try {
	        	Message msgIn = pipeParser.parse(msh);        	
	...
	public void testUpdatePatientRequestId(){	      
		String msh="MSH|^~\\&|PAT_IDENTITY_X_REF_MGR_IBM1|IBM1|EHR_MISYS|MISYS|20060809155816-0400||ADT^A08^ADT_A08|PIF_0|P|2.3.1||||||||\r"+ 
		"EVN|A08|20060809155816||||20060809155814\r"+
		"PID|||123456789^^^WESTCLINIC&1.2234.634325.5734&ISO^PI||DePinto^Joe^V^Jr^Dr.|Wang|19580325|M|||||(716)385-6235^PRN^PH^^^716^3856235\r"+
		"PV1||O";
	        PipeParser pipeParser = new PipeParser();
	        try {
	        	Message msgIn = pipeParser.parse(msh);        	
	...
	public void testInvalidMergePatient(){
		String msh ="MSH|^~\\&|PAT_IDENTITY_X_REF_MGR_IBM1|IBM1|EHR_MISYS|MISYS|20060919004624-0400||ADT^A40^ADT_A39|PIF_3|P|2.3.1||||||||\r"+
		"EVN|A40|20060919004624||||20060919004340\r"+
		"PID|||12345678^^^WESTCLINIC&1.2234.634325.5734&ISO^PI||DePinto^Joe^V^Jr^Dr.|Wang|19580325|M|raja|race|||(716)385-6235^PRN^PH^^^716^3856235||tamil|U|hindu|077746567576|666777888|9877876|priya|ethnic|tamilnadu||1|indian||||090120071011|1|\r"+
		"MRG|445233^^^MIEH^PI||||||Tusona^Luis^N^Sr^Dr.\r";		
	        PipeParser pipeParser = new PipeParser();
	        try {
	        	Message msgIn = pipeParser.parse(msh);        	
	        	Message resposeMsg= new PixFeedHandler(actor).processMessage(msgIn);
	...
	private String getErrorMsg(ERR msgIn)throws HL7Exception {
		...
		erl.getSequence().getValue()+","+
		erl.getFieldPosition().getValue()+","+		
		erl.getCodeIdentifyingError().getIdentifier().getValue()+","+
		erl.getCodeIdentifyingError().getText().getValue();
		return errorMsg;
}
